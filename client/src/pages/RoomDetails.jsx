...
const RoomDetails = () => {
    ...
    const checkAvailability = async ()=>{
        try {
            // check in date is grater than check out date
            if(checkInDate >= checkOutDate){
                toast.error("Check-In date should be less than check-Oue date");
                return;
            }
    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                ...
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input onChange={(e)=>setCheckInDate(e.target.value) } min={new Date().toISOString().split('T')[0]} 
                         type="date" id='checkInDate' placeholder="Check-In" className='w-full rounded border border-gray-300 px-3 py-2
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input onChange={(e)=>setCheckOutDate(e.target.value) } min={checkInDate} disabled={!checkInDate} type="date" id='checkOutDate' placeholder="Check-Out" className='w-full rounded border border-gray-300 px-3 py-2
                        mt-1.5 outline-none' required />
                    </div>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guests will be allocated on the ground floor according to availability. You get a 
